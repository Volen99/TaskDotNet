namespace TaskDotNet.Web
{
    using System.Reflection;

    using TaskDotNet.Data;
    using TaskDotNet.Data.Common;
    using TaskDotNet.Data.Common.Repositories;
    using TaskDotNet.Data.Models;
    using TaskDotNet.Data.Repositories;
    using TaskDotNet.Data.Seeding;
    using TaskDotNet.Services.Data;
    using TaskDotNet.Services.Mapping;
    using TaskDotNet.Services.Messaging;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IEmployeeOfficeServices, EmployeeOfficeServices>();
        }
                ...
                endpoints =>
                    {
                        endpoints.MapControllerRoute(
                            "TaskDotNetCompany",
                            "f/{name:minlength(3)}",
                            new { controller = "Companies", action = "ByName" });
